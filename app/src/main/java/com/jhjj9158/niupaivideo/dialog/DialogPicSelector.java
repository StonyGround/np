        ...
        switch (v.getId()) {
            case R.id.photo:
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    uri = FileProvider.getUriForFile(context, context.getApplicationContext()
                            .getPackageName() + ".provider", new File(Environment
            ...
            case R.id.local:
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                    ...
                    intentLocal = new Intent(Intent.ACTION_GET_CONTENT);
                }
                intentLocal.setType(IMAGE_UNSPECIFIED);
                Intent wrapperIntent = Intent.createChooser(intentLocal, null);
                ((Activity) context).startActivityForResult(wrapperIntent, Contact
                        .REQUEST_PHOTO_ZOOM);
                DialogPicSelector.this.dismiss();
                break;
            case R.id.cancle:
